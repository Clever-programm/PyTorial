...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutScrollMain.addStretch(1)
        self.null_label = QtWidgets.QLabel()
        self.null_label.setGeometry(QtCore.QRect(0, 0, 980, 110))
        self.null_label.setText("")
        self.null_label.setObjectName("null_label")
        self.null_label.setFixedSize(980, 50)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.null_label.sizePolicy().hasHeightForWidth())
        self.null_label.setSizePolicy(sizePolicy)
        self.layoutScrollMain.addWidget(self.null_label)
        self.teaher_btn = ClickedLabel()
        self.teaher_btn.setGeometry(QtCore.QRect(0, 0, 980, 110))
        self.teaher_btn.setText("")
        self.teaher_btn.setPixmap(QtGui.QPixmap("Data/Images/PyTutorial_Courses_9.png"))
        self.teaher_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.teaher_btn.setObjectName("teacher_btn")
        self.teaher_btn.setFixedSize(980, 110)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.teaher_btn.sizePolicy().hasHeightForWidth())
        self.teaher_btn.setSizePolicy(sizePolicy)
        self.teaher_btn.hide()
        self.layoutScrollMain.addWidget(self.teaher_btn)
        # scroll Lesson
